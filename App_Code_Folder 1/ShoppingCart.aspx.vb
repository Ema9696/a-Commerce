...
#Region "Properties"
    ...
    Public Property Items() As List(Of ListItem)
        Get
            Return m_Items
        End Get
        Private Set(value As List(Of ListItem))
            m_Items = value
        End Set
    End Property
    Private m_Items As List(Of ListItem)
...
#Region "Singleton Implementation"
    ...
    Shared Sub New()
        ...
        If HttpContext.Current.Session("ASPNETShoppingCart") Is Nothing Then
            ...
            Instance.Items = New List(Of ListItem)()
...
#Region "Item Modification Methods"
    ...
    Public Sub AddItem(productId As Integer)
        ' Create a new item to add to the cart
        Dim newItem As New ListItem(productId)
