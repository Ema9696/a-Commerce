<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Brand1.aspx.vb" Inherits="a_Commerce.Brand1" %>
...
<body>
    ...
    <div>
        ...
        <link href="BrandCss1.css" rel="stylesheet" type="text/css" /> 
 ...
 <a href="#" class="button facebook"><span><i class="icon-facebook"></i></span><p>Facebook</p></a>
  ...
  <a href="#" class="button dribbble"><span><i class="icon-dribbble"></i></span><p>dribbble</p></a>
   ...
   <a href="#" class="button pinterest"><span><i class="icon-pinterest"></i></span><p>pinterest</p></a>
     ...
     <a href="#" class="button stackexchange"><span><i class="icon-stackexchange"></i></span><p>stack overflow</p></a>
  
     <a href="#" class="button flickr"><span><i class="icon-flickr"></i></span><p>flickr</p></a>
     --->
...
<!---
<div class="copyright">
  <p>Forked of <a href="http://www.fwpolice.com">The Fireworks Police</a> <br>
Recreated by Ese Coal &amp; Dammyammy
  </p><br> <p><a href="http://techcompanionng.com">TECH COMPANION NIGERIA</a> <br>dammy at techcompanionng dot com<br>
  ese underscore gift2001 at yahoo dot com</p>
  <p>Brand Logos By: <a href="http://fortawesome.github.io/Font-Awesome">Font Awesome</a> &amp Brand Colors by: <a href="http://brandcolors.net/">Brand Colors</a> </p>

  <h3 class="text-center">Extend &amp; Enjoy</h3>
</div>
---->
