				...
				<div class="row">
					<div class="col-md-6 fadein scaleInv anim_1">
						<div class="fadein scaleInv anim_2">
							<h1 class="carouselText1 animated fadeInUpBig">Welcome to <span class="colortext">arpa-SRL</span></h1>
						</div>
            ...
            <div class="well">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        Anonimo</span> <span class="pull-right">
                            10 days ago</span>
                        <p>
	...
	<div id="contact" class="footer">
		<div class="container animated fadeInUpNow notransition">
			<div class="row">
				...
				<div class="col-md-3">
					<h1 class="title">Messaggio Veloce</h1>
					<div class="done">
