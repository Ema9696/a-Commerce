<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CambiaPw.aspx.vb" Inherits="a_Commerce.CambiaPw" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>a Commerce Cambia Password</title>
</head>
<body>
...
&nbsp;<asp:SiteMapPath ID="SiteMapPath1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" Height="38px" 
            Text="Torna a Profilo Utente" Width="546px" />
        <br />
        <br />
        <asp:Button ID="Button2" runat="server" Height="38px" 
            Text="Torna alla Home Page" Width="546px" />
        <br />
        <br />
