<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserProfile.aspx.vb" Inherits="a_Commerce.UserProfile" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>a Commerce Profilo Utente</title>
</head>
<body>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &gt;<br />
        <br />
        <asp:Button ID="Button4" runat="server" Text="Visualizza Storico Ordini" 
            Width="312px" Height="51px" />
        <br />
        <br />
        <asp:Button ID="Button5" runat="server" Text="Visualizza I Miei Oggetti in Vendita" 
            Width="312px" Height="51px" />
        <br />
        <br />
        ----------------------------------------------------<br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Cambia Password" Width="313px" 
            Height="31px" />
        <br />
        <br />
        <asp:Button ID="Button2" runat="server" Text="Dati Spedizione" Width="313px" />
        <br />
        <br />
        <asp:Button ID="Button3" runat="server" Text="-" Width="313px" />
        <br />
        <br />
        <br />
        <br />
